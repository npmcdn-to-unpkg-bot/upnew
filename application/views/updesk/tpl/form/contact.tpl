...
<form class="contact-form js-oxValidate" action="[{$oViewConf->getSslSelfLink()}]" method="post">
    <div>
        ...
        <input type="hidden" name="c_mach" value="[{$oCaptcha->getHash()}]"/>
            ...
            [{up_html_checkout_input ident="FIRST_NAME" type="text" name="editval.oxuser__oxfname" ocu=$oxcmp_user }]
            [{up_html_checkout_input ident="LAST_NAME" type="text" name="editval.oxuser__oxlname"  ocu=$oxcmp_user }]
            [{up_html_checkout_input ident="EMAIL" type="text" name="editval.oxuser__oxusername"  ocu=$oxcmp_user }]
            [{up_html_checkout_input ident="SUBJECT" type="text" name="c_subject"   ocu=$oxcmp_user }]
           
           
            <div class="form-group">
            <label>[{oxmultilang ident="MESSAGE"}]</label>
            <textarea class="form-control" rows="8" name="c_message" class="contact-form-message areabox">[{$oView->getContactMessage()}]</textarea>
    ...
    <ul class="form clear">
        ...
        <li [{if $aErrors.oxuser__oxusername}]class="invalid-field"[{/if}]>
         ...
         [{up_html_checkout_input ident="EMAIL" type="text" name="editval.oxuser__oxusername"  parentclass="col-lg-6" ocu=$oxcmp_user }]
        ...
        <li [{if $aErrors && !$oView->getContactSubject()}]class="invalid-field"[{/if}]>
          ...
          [{up_html_checkout_input ident="SUBJECT" type="text" name="c_subject"  parentclass="col-lg-6" ocu=$oxcmp_user }]
