                ...
                <tr valign="top">
                    ...
                    <td style="padding: 5px; border-bottom: 4px solid #ddd;">
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0; padding: 0;">
                            ...
                            <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0; padding: 10px 0;">
                            [{if $basketproduct->getVarStockStatus() == -1}]
                                <span class="product-stock-flag no-stock">
                                    [{if $basketproduct->getDeliveryDate()}]
                                        ...
                                        [{oxmultilang ident="AVAILABLE_ON"}] [{$basketproduct->getDeliveryDate()}]
                                        </span>
                                    [{else}]
                            ...
                            [{elseif $basketproduct->getVarStockStatus() == 1}]
                            ...
                            [{elseif $basketproduct->getVarStockStatus() == 0}]
                            ...
                            [{elseif $basketproduct->getVarStockStatus() == 99}]
                                <span class="product-stock-flag low-stock" style="color:#07B107;">
