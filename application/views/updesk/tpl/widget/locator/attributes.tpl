[{if $attributes}]
    ...
    <div id="filterItems" class="filter-box">
        <div class="filter-box-closed" id="filterBoxClosed">
            <div class="row listing-thirds">
                <div class="col-xs-12">   
                    <div role="button">[{* oxmultilang ident="FILTER_LIST" *}]Filter <i class="glyphicon glyphicon-chevron-down"></i> </div>
                </div>
            </div>
        </div>
        ...
        <div id="filterBoxOpened" class="filter-box-opened">
            <div class="filter-header">
                <span class="filter-close"><i class="glyphicon glyphicon-remove"></i></span>
                <span class="filter-open-title">[{* oxmultilang ident="FILTER_LIST" *}]Filter</span>
            </div>
