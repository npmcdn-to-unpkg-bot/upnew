...
( function( $ ) {
    oxToBasket = {
        ...
        _create: function () {
           ...
           // $("#js-openMiniBasket").click( loadBasket);
        },
    ...
    function formSubmit() {
       ...
       // alert( $( "input[name=fnc]", this ).val() );
         return oxToBasket.reload( $(target),$("#minibasket_container"),$("#minibasket_container")[0], aOptions);
    }
    ...
    function preAjaxCaller() {
        ...
        //$('#zoomModal').remove();
         //$('#minibasket_container').html('<div class="pusher pusher-for-minibasket"></div>'); //will be overridden once content is loaded into parent
         $('#mfmask').show();
         $('#minibasket_container').addClass('open');
    }

    $.widget( "ui.oxToBasket", oxToBasket );
